	...
	async render(state: void, sizing: PromptSizing) {
		...
		return <InstructionMessage>
			<Tag name='instructions'>
				...
				{tools[ToolName.GithubContextSubagent] && <>For retrieving GitHub context (issues, PRs, commits, documentation), use {ToolName.GithubContextSubagent} to gather relevant artifacts. You can pass your whole task for broad context or make targeted requests. Do not use it for code that is already in the workspace.<br /></>}
