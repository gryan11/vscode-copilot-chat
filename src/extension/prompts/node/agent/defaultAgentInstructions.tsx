	...
	async render(state: void, sizing: PromptSizing) {
		...
		return <InstructionMessage>
			<Tag name='instructions'>
				...
				{tools[ToolName.GithubContextSubagent] && <>IMPORTANT: At the start of every new task, ALWAYS call {ToolName.GithubContextSubagent} first. You MUST provide repoOwner and repoName. Pass the FULL task description. Then: (1) read files mentioned in context first, (2) follow any fix approach or function signatures described, (3) use code suggestions from issue comments as implementation guide, (4) match code patterns from PR diffs, (5) verify ALL mentioned files were handled.<br /></>}
